...
const BUILD = /* web-components */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: false, propNumber: true, propString: true, reflect: false, safari10: false, scoped: true, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: false, shadowDomShim: true, slot: false, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: true, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: true, watchCallback: false };
...
const createElm = (e, t, o, n) => {
 ...
 for (BUILD.shadowDom   ; s <= l; ++s) n[s] && (a = createElm(null, o, s, e), 
...
const appCommunityCss = ".sc-app-community-h{display:block}";
...
class TRSFilerComponent {
  constructor(hostRef) {
    ...
    this.renderSearchBar = () => {
      return (hAsync("div", { class: "flex" }, hAsync("input", { class: "flex-1 text-sm border-2 py-2 px-3 focus:outline-none rounded-lg focus:shadow mr-2", placeholder: "Search by service name...", value: this.searchService, onInput: (e) => this.handleSearchQuery(e) }), hAsync("button", { class: "py-2 px-5 bg-primary text-xs text-white rounded-lg focus:outline-none w-24" }, "All")));
    };
    this.renderServices = () => {
      return this.tools.map((tool, index) => {
        return (hAsync("div", { class: `flex-row border-2 border-gray-100 rounded-lg hover:shadow-md mt-2 px-3 py-2 ${this.serviceIsOpen[index] ? "shadow-md" : "shadow-sm"}` }, hAsync("div", { class: `flex justify-between cursor-pointer focus:outline-none ${this.serviceIsOpen[index] ? "border-b-2 pb-2" : ""}`, onClick: () => this.toggleOpen(index) }, hAsync("div", { class: `title text-lg font-semibold` }, `Tool with ID: ${tool.id}`), hAsync("div", { class: "mt-0.5" }, hAsync("span", { class: "text-xs italic font-extralight mr-2" }, tool.type), this.serviceIsOpen[index] ? (hAsync("svg", { xmlns: "http://www.w3.org/2000/svg", class: "h-5 w-5 inline", viewBox: "0 0 20 20", fill: "currentColor" }, hAsync("path", { "fill-rule": "evenodd", d: "M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z", "clip-rule": "evenodd" }))) : (hAsync("svg", { xmlns: "http://www.w3.org/2000/svg", class: "h-5 w-5 inline", viewBox: "0 0 20 20", fill: "currentColor" }, hAsync("path", { "fill-rule": "evenodd", d: "M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z", "clip-rule": "evenodd" }))))), hAsync("div", { class: `wc-service-index-${index} ${this.serviceIsOpen[index] ? "" : "hidden"} pt-2 text-left` }, hAsync("a", { href: tool.documentationUrl, class: "text-primary text-xs font-bold cursor-pointer border-b-2 border-white transition ease-out duration-500 hover:border-primary", target: "_blank", rel: "noopener noreferrer" }, tool.url), hAsync("div", { class: "text-gray-500" }, tool.desription), hAsync("br", null), hAsync("div", null, hAsync("div", { class: "" }, hAsync("span", { class: "" }, "Service Id:"), " ", hAsync("span", { class: "font-mono" }, tool.id)), hAsync("div", { class: "text-base" }, hAsync("span", { class: "" }, "Organization:"), " ", tool.organization.name, " ", hAsync("a", { href: tool.organization.url, target: "_blank", rel: "noopener noreferrer" }, hAsync("svg", { xmlns: "http://www.w3.org/2000/svg", class: "h-4 w-4 mb-1 ml-2 text-primary inline", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, hAsync("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" }))), hAsync("a", { href: tool.contactUrl, target: "_blank", rel: "noopener noreferrer" }, hAsync("svg", { xmlns: "http://www.w3.org/2000/svg", class: "h-4 w-4 mb-1 ml-1.5 text-primary inline", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, hAsync("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" })))), hAsync("div", { class: "text-base" }, hAsync("span", { class: "" }, "Version:"), " ", hAsync("span", { class: "font-mono" }, tool.meta_version))))));
      });
    };
  }
  componentDidLoad() {
