            ...
            >
              ...
              <div class="text-sm">
                <div class="md:flex md:justify-between">
                  {service.type ? (
                    <div>
                      <button class="bg-primary rounded-lg px-4 py-2 md:mr-4 my-2 text-white hover:shadow-lg focus:outline-none w-full md:w-auto">
                        Edit Service
                      </button>
                      <button
                      ...
                      {service.type == "Owned" ? (
                        <button class="bg-gray-300 rounded-lg px-4 py-2 md:mx-2 my-2 text-gray-500 hover:shadow-lg focus:outline-none w-full md:w-auto">
                          Delete Service
                        </button>
                      ) : (
                        <div></div>
